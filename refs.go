...
func (c *httpClient) CreateRef(ctx context.Context, ref Ref) error {
	...
	req := protocol.NewCreateRefRequest(ref.Name, ref.Hash, c.pushCapabilities...)
	pkt, err := req.Format()
	if err != nil {
...
func (c *httpClient) UpdateRef(ctx context.Context, ref Ref) error {
	...
	req := protocol.NewUpdateRefRequest(oldRef.Hash, ref.Hash, ref.Name, c.pushCapabilities...)
	pkt, err := req.Format()
	if err != nil {
...
func (c *httpClient) DeleteRef(ctx context.Context, refName string) error {
	...
	req := protocol.NewDeleteRefRequest(oldRef.Hash, refName, c.pushCapabilities...)
	pkt, err := req.Format()
	if err != nil {
