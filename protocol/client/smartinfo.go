...
func (c *rawClient) SmartInfo(ctx context.Context, service string) ([]byte, error) {
	...
	logger.Debug("Starting smart info request", "url", u.String(), "service", service)
	...
	logger.Debug("Received smart info response",
		"status", res.StatusCode,
		"statusText", res.Status,
		"responseSize", len(body))
	logger.Debug("Smart info raw response", "body", string(body))
