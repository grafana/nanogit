...
test-coverage:
	go run github.com/onsi/ginkgo/v2/ginkgo --race --randomize-all --randomize-suites --fail-on-pending -p --coverprofile=coverage.txt --covermode=atomic --coverpkg=./tests/...
