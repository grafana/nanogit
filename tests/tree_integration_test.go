...
var _ = Describe("Trees", func() {
	Context("GetFlatTree operations", func() {
		...
		BeforeEach(func() {
			...
			_ = local.CreateFile("dir1/file1.txt", "content1")
			_ = local.CreateFile("dir1/file2.txt", "content2")
			_ = local.CreateFile("dir2/file3.txt", "content3")
			_ = local.CreateFile("root.txt", "root content")
	...
	Context("GetFlatTree complex structure", func() {
		...
		BeforeEach(func() {
			...
			_ = local.CreateDirPath("dir1/subdir1/subsubdir1")
			_ = local.CreateDirPath("dir1/subdir2")
			_ = local.CreateDirPath("dir2/subdir1")
			_ = local.CreateDirPath("dir3")

			_ = local.CreateFile("dir1/subdir1/subsubdir1/file1.txt", "content1")
			_ = local.CreateFile("dir1/subdir1/file2.txt", "content2")
			_ = local.CreateFile("dir1/subdir2/file3.txt", "content3")
			_ = local.CreateFile("dir2/subdir1/file4.txt", "content4")
			_ = local.CreateFile("dir2/file5.txt", "content5")
			_ = local.CreateFile("dir3/file6.txt", "content6")
			_ = local.CreateFile("root.txt", "root content")
	...
	Context("GetFlatTree with fallback fetch", func() {
		...
		BeforeEach(func() {
			...
			_ = local.CreateDirPath("level1/level2a/level3a")
			_ = local.CreateDirPath("level1/level2a/level3b")
			_ = local.CreateDirPath("level1/level2b/level3c")
			_ = local.CreateDirPath("level1/level2b/level3d/level4")

			// Add files at various levels
			_ = local.CreateFile("level1/file1.txt", "content at level1")
			_ = local.CreateFile("level1/level2a/file2a.txt", "content at level2a")
			_ = local.CreateFile("level1/level2a/level3a/file3a.txt", "content at level3a")
			_ = local.CreateFile("level1/level2a/level3b/file3b.txt", "content at level3b")
			_ = local.CreateFile("level1/level2b/file2b.txt", "content at level2b")
			_ = local.CreateFile("level1/level2b/level3c/file3c.txt", "content at level3c")
			_ = local.CreateFile("level1/level2b/level3d/file3d.txt", "content at level3d")
			_ = local.CreateFile("level1/level2b/level3d/level4/file4.txt", "deep content at level4")
	...
	Context("GetFlatTree with submodule", func() {
		...
		Expect(err).NotTo(HaveOccurred())
			...
			_ = local.CreateFile("src/main.txt", "main content")
			_ = local.CreateFile("README.md", "readme")
			_, _ = local.Git("add", ".")
